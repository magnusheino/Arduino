...
#ifndef RemoteReceiver2_h
#define RemoteReceiver2_h
...
class RemoteReceiver2 {
	public:
		...
		*/
		static void init(unsigned short interrupt, unsigned short minRepeats, RemoteReceiverCallBack callback, unsigned int estPulseWidth);
	...
	private:
		...
		volatile static short		_state;				//State of decoding process. There are 129 states, -1 for "waiting for signal" and 128 for decoding the 128 edges in a valid code.
