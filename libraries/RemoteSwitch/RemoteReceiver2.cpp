...
unsigned short		RemoteReceiver2::_interrupt;
volatile short		RemoteReceiver2::_state;
unsigned short		RemoteReceiver2::_minRepeats;
RemoteReceiverCallBack	RemoteReceiver2::_callback;
boolean			RemoteReceiver2::_inCallback = false;
unsigned int		RemoteReceiver2::_estSyncWidth;

void RemoteReceiver2::init(unsigned short interrupt, unsigned short minRepeats, RemoteReceiverCallBack callback, unsigned int estPulseWidth) {
...
void RemoteReceiver2::enable() {
	_state = -1;
	attachInterrupt(_interrupt, interruptHandler, CHANGE);
}

void RemoteReceiver2::disable() {
	detachInterrupt(_interrupt);
}


void RemoteReceiver2::interruptHandler() {
...
boolean RemoteReceiver2::isReceiving(int waitMillis) {
